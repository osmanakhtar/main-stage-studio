...
- [ ] Client folder created at `~/workspace/main-stage-studio/02_clients/[client-name]/` — **not inside `01_mss/`**
- [ ] Folder structure copied from `~/workspace/main-stage-studio/02_clients/_template/`
- [ ] `discovery/constraints.md` opened and filled in before any design work (template in the `_template/discovery/` folder)
...
- [ ] `cd ~/workspace/main-stage-studio/02_clients/[client-name]/` confirmed as working directory
...
- [ ] Case study folder created at `~/workspace/main-stage-studio/01_mss/portfolio/[client-name]/`
