...
| Untracked working-tree content | As of 19 June 2026, significant uncommitted work is sitting in the working tree: `01_mss/portfolio/apex-fc/` (untracked), Sable brand assets (11 files, untracked), `01_mss/strategy/` (count was 13 files as of 19 June — stale, two files were removed during the 20 June session; re-verify before starting the review), and modified-but-unstaged changes to both case-study.html files and the website index.html. This is real, separate site/asset work, not part of the documentation cleanup — needs its own review session before committing. |
